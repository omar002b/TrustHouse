...
export const initialProperties: Property[] = [
  {
    ...
    viewings: 8,
    description:
      "Moderno apartamento en el centro de Madrid con todas las comodidades. Completamente reformado con acabados de alta calidad, cocina equipada, aire acondicionado y calefacción central.",
    customQuestions: [
      {
        id: "1",
        type: "yesno",
  ...
  },
  {
    ...
    viewings: 15,
    description:
      "Amplio piso familiar en zona tranquila con parques cercanos. Ideal para familias, con espacios amplios y mucha luz natural.",
    customQuestions: [
      {
        id: "1",
        type: "yesno",
...
export const initialViewings: Viewing[] = [
  {
    id: 1,
    propertyId: 1,
